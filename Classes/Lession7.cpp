...
Scene* Lession7::createScene()
{
    // 'scene' is an autorelease object
    auto scene = Scene::create();
    
    // 'layer' is an autorelease object
    auto layer = Lession7::create();
...
bool Lession7::init()
{
	...
	FileUtils::getInstance()->addSearchPath(FileUtils::getInstance()->getSearchPaths().at(0) + "Lession7/");
	...
	auto shader = GLProgram::createWithFilenames("Lessioni7.vert", "Lessioni7.frag");
	...
	schedule(schedule_selector(Lession7::UpdateTexUVAni, this));

    return true;
}

void Lession7::UpdateTexUVAni(float dt)
{
	m_TexUVAni.x += dt;
